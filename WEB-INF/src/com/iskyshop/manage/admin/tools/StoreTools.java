...
public class StoreTools {
	...
	/**
	 * 查询商家可显示的分类信息，显示的分类为二级分类，用在商家发布商品、添加0元购商品的查询，添加团购商品的查询
	 * 
	 * @param store
	 * @return
	 */
	public List<GoodsClass> query_store_gc(Store store) {
		...
		if (store.getGc_detail_info() != null
			...
			Set<GoodsClass> gc_list = this.query_store_DetailGc(store
					.getGc_detail_info());
			gcs.addAll(gc_list);
		} else {
