...
public class Globals {
	public final static String DEFAULT_SYSTEM_TITLE = "ISkyShop B2B2C商城系统";// 系统默认名称
	public final static boolean SSO_SIGN = true;// 是否允许单点登录，店铺二级域名开启
	public final static int DEFAULT_SHOP_VERSION = 20150315;// 软件发布小版本号
	public final static String DEFAULT_SHOP_OUT_VERSION = "V2.0";// 软件大版本号
	public final static String DEFAULT_WBESITE_NAME = "ISkyShop";// 软件名称
	...
	public final static String DEFAULT_TABLE_SUFFIX = "iskyshop_";// 默认表前缀名
